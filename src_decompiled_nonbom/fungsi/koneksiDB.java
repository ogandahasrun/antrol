...
public class koneksiDB {
    ...
    public static Connection condb() {
        if (connection == null) {
            try {
                ...
                dataSource.setURL("jdbc:mysql://" + EnkripsiAES.decrypt((String)prop.getProperty("HOST")) + ":" + EnkripsiAES.decrypt((String)prop.getProperty("PORT")) + "/" + EnkripsiAES.decrypt((String)prop.getProperty("DATABASE")) + "?zeroDateTimeBehavior=convertToNull&autoReconnect=true&useCompression=true");
                dataSource.setUser(EnkripsiAES.decrypt((String)prop.getProperty("USER")));
                dataSource.setPassword(EnkripsiAES.decrypt((String)prop.getProperty("PAS")));
                ...
                try {
                    if (connection.isClosed()) {
                        prop.loadFromXML(new FileInputStream("setting/database.xml"));
                        dataSource.setURL("jdbc:mysql://" + EnkripsiAES.decrypt((String)prop.getProperty("HOST")) + ":" + EnkripsiAES.decrypt((String)prop.getProperty("PORT")) + "/" + EnkripsiAES.decrypt((String)prop.getProperty("DATABASE")) + "?zeroDateTimeBehavior=convertToNull&amp;autoReconnect=true&amp;cachePrepStmts=true");
                        dataSource.setUser(EnkripsiAES.decrypt((String)prop.getProperty("USER")));
                        dataSource.setPassword(EnkripsiAES.decrypt((String)prop.getProperty("PAS")));
                        connection = dataSource.getConnection();
                    }
    ...
    public static String HOST() {
        try {
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var = EnkripsiAES.decrypt((String)prop.getProperty("HOST"));
        }
        catch (Exception e) {
            var = "";
        }
    ...
    public static String DATABASE() {
        try {
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var = EnkripsiAES.decrypt((String)prop.getProperty("DATABASE"));
        }
        catch (Exception e) {
            var = "";
        }
    ...
    public static String PORT() {
        try {
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var = EnkripsiAES.decrypt((String)prop.getProperty("PORT"));
        }
        catch (Exception e) {
            var = "";
        }
    ...
    public static String USER() {
        try {
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var = EnkripsiAES.decrypt((String)prop.getProperty("USER"));
        }
        catch (Exception e) {
            var = "";
        }
    ...
    public static String HOSTHYBRIDWEB() {
        try {
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var = EnkripsiAES.decrypt((String)prop.getProperty("HOSTHYBRIDWEB"));
        }
        catch (Exception e) {
            var = "";
        }
    ...
    public static String SECRETKEYAPIBPJS() {
        try {
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var = EnkripsiAES.decrypt((String)prop.getProperty("SECRETKEYAPIBPJS"));
        }
        catch (Exception e) {
            var = "";
        }
    ...
    public static String CONSIDAPIBPJS() {
        try {
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var = EnkripsiAES.decrypt((String)prop.getProperty("CONSIDAPIBPJS"));
        }
        catch (Exception e) {
            var = "";
        }
    ...
    public static String USERKEYAPIBPJS() {
        try {
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var = EnkripsiAES.decrypt((String)prop.getProperty("USERKEYAPIBPJS"));
        }
        catch (Exception e) {
            var = "";
        }
    ...
    public static String SECRETKEYAPIAPLICARE() {
        try {
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var = EnkripsiAES.decrypt((String)prop.getProperty("SECRETKEYAPIAPLICARE"));
        }
        catch (Exception e) {
            var = "";
        }
    ...
    public static String CONSIDAPIAPLICARE() {
        try {
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var = EnkripsiAES.decrypt((String)prop.getProperty("CONSIDAPIAPLICARE"));
        }
        catch (Exception e) {
            var = "";
        }
    ...
    public static String USERKEYAPIAPLICARE() {
        try {
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var = EnkripsiAES.decrypt((String)prop.getProperty("USERKEYAPIAPLICARE"));
        }
        catch (Exception e) {
            var = "";
        }
    ...
    public static String SECRETKEYAPIMOBILEJKN() {
        try {
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var = EnkripsiAES.decrypt((String)prop.getProperty("SECRETKEYAPIMOBILEJKN"));
        }
        catch (Exception e) {
            var = "";
        }
    ...
    public static String CONSIDAPIMOBILEJKN() {
        try {
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var = EnkripsiAES.decrypt((String)prop.getProperty("CONSIDAPIMOBILEJKN"));
        }
        catch (Exception e) {
            var = "";
        }
    ...
    public static String USERKEYAPIMOBILEJKN() {
        try {
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var = EnkripsiAES.decrypt((String)prop.getProperty("USERKEYAPIMOBILEJKN"));
        }
        catch (Exception e) {
            var = "";
        }
    ...
    public static String SECRETKEYAPIPCARE() {
        try {
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var = EnkripsiAES.decrypt((String)prop.getProperty("SECRETKEYAPIPCARE"));
        }
        catch (Exception e) {
            var = "";
        }
    ...
    public static String CONSIDAPIPCARE() {
        try {
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var = EnkripsiAES.decrypt((String)prop.getProperty("CONSIDAPIPCARE"));
        }
        catch (Exception e) {
            var = "";
        }
    ...
    public static String PASSPCARE() {
        try {
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var = EnkripsiAES.decrypt((String)prop.getProperty("PASSPCARE"));
        }
        catch (Exception e) {
            var = "";
        }
    ...
    public static String USERPCARE() {
        try {
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var = EnkripsiAES.decrypt((String)prop.getProperty("USERPCARE"));
        }
        catch (Exception e) {
            var = "";
        }
    ...
    public static String IDSISRUTE() {
        try {
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var = EnkripsiAES.decrypt((String)prop.getProperty("IDSISRUTE"));
        }
        catch (Exception e) {
            var = "";
        }
    ...
    public static String PASSSISRUTE() {
        try {
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var = EnkripsiAES.decrypt((String)prop.getProperty("PASSSISRUTE"));
        }
        catch (Exception e) {
            var = "";
        }
    ...
    public static String IDSIRS() {
        try {
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var = EnkripsiAES.decrypt((String)prop.getProperty("IDSIRS"));
        }
        catch (Exception e) {
            var = "";
        }
    ...
    public static String PASSSIRS() {
        try {
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var = EnkripsiAES.decrypt((String)prop.getProperty("PASSSIRS"));
        }
        catch (Exception e) {
            var = "";
        }
    ...
    public static String IDCORONA() {
        try {
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var = EnkripsiAES.decrypt((String)prop.getProperty("IDCORONA"));
        }
        catch (Exception e) {
            var = "";
        }
    ...
    public static String PASSCORONA() {
        try {
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var = EnkripsiAES.decrypt((String)prop.getProperty("PASSCORONA"));
        }
        catch (Exception e) {
            var = "";
        }
    ...
    public static String IDSITT() {
        try {
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var = EnkripsiAES.decrypt((String)prop.getProperty("IDSITT"));
        }
        catch (Exception e) {
            var = "";
        }
    ...
    public static String PASSSITT() {
        try {
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var = EnkripsiAES.decrypt((String)prop.getProperty("PASSSITT"));
        }
        catch (Exception e) {
            var = "";
        }
    ...
    public static String TOKENINHEALTH() {
        try {
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var = EnkripsiAES.decrypt((String)prop.getProperty("TOKENINHEALTH"));
        }
        catch (Exception e) {
            var = "";
        }
    ...
    public static String USERDUKCAPILJAKARTA() {
        try {
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var = EnkripsiAES.decrypt((String)prop.getProperty("USERDUKCAPILJAKARTA"));
        }
        catch (Exception e) {
            var = "";
        }
    ...
    public static String PASSDUKCAPILJAKARTA() {
        try {
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var = EnkripsiAES.decrypt((String)prop.getProperty("PASSDUKCAPILJAKARTA"));
        }
        catch (Exception e) {
            var = "";
        }
    ...
    public static String USERDUKCAPIL() {
        try {
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var = EnkripsiAES.decrypt((String)prop.getProperty("USERDUKCAPIL"));
        }
        catch (Exception e) {
            var = "";
        }
    ...
    public static String PASSDUKCAPIL() {
        try {
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var = EnkripsiAES.decrypt((String)prop.getProperty("PASSDUKCAPIL"));
        }
        catch (Exception e) {
            var = "";
        }
    ...
    public static String KEYWSLICA() {
        try {
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var = EnkripsiAES.decrypt((String)prop.getProperty("KEYWSLICA"));
        }
        catch (Exception e) {
            var = "";
        }
    ...
    public static String HPPFARMASI() {
        try {
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var = prop.getProperty("HPPFARMASI").equals("h_beli") ? "h_beli" : "dasar";
        }
        catch (Exception e) {
            var = "dasar";
        }
    ...
    public static String HPPTOKO() {
        try {
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var = prop.getProperty("HPPTOKO").equals("h_beli") ? "h_beli" : "dasar";
        }
        catch (Exception e) {
            var = "dasar";
        }
    ...
    public static String SECRETKEYAPIMEDQLAB() {
        try {
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var = EnkripsiAES.decrypt((String)prop.getProperty("SECRETKEYAPIMEDQLAB"));
        }
        catch (Exception e) {
            var = "";
        }
    ...
    public static String CONSIDAPIMEDQLAB() {
        try {
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var = EnkripsiAES.decrypt((String)prop.getProperty("CONSIDAPIMEDQLAB"));
        }
        catch (Exception e) {
            var = "";
        }
